...
const WA_LINK = 'https://chat.whatsapp.com/HhDBK5j5f9sCsiYxrD8VUj?s=sh&p=a&ilr=0&amv=2'
    ...
    <div className="lp-root">
      <nav className="lp-nav">
        ...
        <div className="lp-nav-links">
          <a href={WA_LINK} target="_blank" rel="noopener noreferrer" className="lp-nav-wa">
            <WhatsAppIcon />
      ...
      <section className="lp-hero">
        <div className="lp-hero-left">
          ...
          <div className="lp-hero-actions">
            ...
            <Link to="/register/teacher" className="lp-btn-secondary">
        ...
        <div className="lp-how-inner">
          ...
          <div className="lp-how-grid">
            <div className="lp-how-step">
              ...
              <p className="lp-how-desc">Inscris-toi en tant qu'élève en moins de 2 minutes. Aucune carte bancaire requise, la plateforme est 100 % gratuite pour les élèves.</p>
            </div>
            <div className="lp-how-step">
              <div className="lp-how-number">2</div>
              <h3 className="lp-how-title">Cherche et filtre les documents</h3>
              <p className="lp-how-desc">Utilise les filtres par matière, niveau et type pour trouver les épreuves et annales qui correspondent exactement à tes besoins.</p>
            </div>
            <div className="lp-how-step">
              <div className="lp-how-number">3</div>
              <h3 className="lp-how-title">Lis en ligne ou télécharge</h3>
              <p className="lp-how-desc">Consulte les documents directement dans ton navigateur ou télécharge-les en PDF pour réviser même sans connexion internet.</p>
            </div>
          </div>
        </div>
      </section>
